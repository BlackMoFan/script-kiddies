...
function updateUser($conn, $user_id, $new_full_name, $new_gender, $new_user_name, $new_birthday, $new_role, $new_employment_status, $new_email, $new_password) {
    if(!empty($new_password)) {
        ...
        $query = "UPDATE users SET full_name='$new_full_name', gender='$new_gender', user_name='$new_user_name', birthday='$new_birthday', role='$new_role', email='$new_email', password='$hashedPwd', employment_status='$new_employment_status' WHERE user_id='$user_id';";
        ...
        $query = "UPDATE users SET full_name='$new_full_name', gender='$new_gender', user_name='$new_user_name', birthday='$new_birthday', role='$new_role', email='$new_email', employment_status='$new_employment_status' WHERE user_id='$user_id';";
        $query_run = mysqli_query($conn, $query);
